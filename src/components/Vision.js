...
export function Vision() {
  return (
    <div>
      ...
      <h3>Meet people and see places</h3>
      <p>I would love to explore the differences across nations, approach to customers and spread the love for hospitality around.</p>
